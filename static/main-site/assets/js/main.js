...
rangeSlider("sqft_range", "min_sqft", "max_sqft", 100, 10000, 0, 20000, wNumb({decimals: 0, thousand: ',', suffix: 'Sqft'}))
...
rangeSlider("sqft_range2", "min_sqft2", "max_sqft2", 100, 10000, 0, 20000, wNumb({decimals: 0, thousand: ',', suffix: 'Sqft'}))
